...
const SupportFeatureCard = ({ feature }: SupportFeatureCardProps) => {
  ...
  return (
    <article className="flex h-full flex-col items-center rounded-2xl border border-slate-100 bg-white px-4 py-6 text-center shadow-[0_8px_30px_rgba(15,35,72,0.06)] transition-transform duration-200 hover:-translate-y-1 hover:shadow-[0_14px_40px_rgba(15,35,72,0.10)] sm:px-5 sm:py-8">
      <div
        className={clsx(
